...
public enum RestStatus {
	 ...
	 * a third-party copy. The set presented MAY be a subset or super set of the
	 * original version. For example, including local annotation information
	 * about the resource might result in a super set of the meta information
	 ...
	 * updated meta information SHOULD be applied to the document currently in
	 ...
	 * <ul>
	 * <li>Either a Content-Range header field (section 14.16) indicating the
	 ...
	 * of OCTETs transmitted in the message-body.</li>
	 * <li>Date</li>
	 ...
	 * further information about the success or failure of the method execution.
	 * The response MAY be used in success, partial success and also in failure
	 * situations.
	 * <p/>
	 * <p>
	 ...
	 * The response MUST include the following header fields:
	 * <ul>
	 * <li>Date, unless its omission is required by section 14.18.1 If a
	 * clockless origin server obeys these rules, and proxies and clients add
	 * their own Date to any response received without one (as already specified
	 * by [RFC 2068], section 14.19), caches will operate correctly.</li>
	 * <li>ETag and/or Content-Location, if the header would have been sent in a
	 * 200 response to the same request</li>
	 * <li>Expires, Cache-Control, and/or Vary, if the field-value might differ
	 * from that sent in any previous response for the same variant</li>
