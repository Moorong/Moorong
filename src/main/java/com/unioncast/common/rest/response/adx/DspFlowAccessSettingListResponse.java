 ...
 */
public class DspFlowAccessSettingListResponse extends RestResponse{
	
	private static final long serialVersionUID = 5690654578854772246L;

	private List<AdxDspFlowAccessSetting> result;

	public List<AdxDspFlowAccessSetting> getResult() {
		return result;
	}

	public void setResult(List<AdxDspFlowAccessSetting> result) {
		this.result = result;
	}
