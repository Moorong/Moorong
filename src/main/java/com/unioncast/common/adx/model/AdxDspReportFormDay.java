 ...
 * </p>
 *
 * @pdOid 7a9b9534-cf34-49cb-8510-80d4d1477af8
 */
@MyTable("adx_dsp_report_form_day")
public class AdxDspReportFormDay implements Serializable {

    private static final long serialVersionUID = -2424391000159168324L;
    public static String PROPERTIES = "id,flow_type,size,show_num,click_num,click_rate,thousand_show_price,advertisers,originality,user_id,date,remarks,update_time";
    public static String TABLE_NAME = "adx_dsp_report_form_day";
    ...
    public AdxDspReportFormDay() {
        super();
    }

    public AdxDspReportFormDay(Long id, Integer flowType, String size, String showNum, String clickNum,
                               Double clickRate, Double thousandShowPrice, String advertisers, String originality, Long userId, Date date,
                               String remarks, Date updateTime) {
        super();
        this.id = id;
    ...
    public static void main(String[] args) throws JsonGenerationException, JsonMappingException, IOException {
        ...
        AdxDspReportFormDay entity = new AdxDspReportFormDay();
    ...
    public String toString() {
        return "AdxDspReportFormDay [id=" + id + ", flowType=" + flowType + ", size=" + size + ", showNum=" + showNum
                + ", clickNum=" + clickNum + ", clickRate=" + clickRate + ", thousandShowPrice=" + thousandShowPrice
                + ", advertisers=" + advertisers + ", originality=" + originality + ", userId=" + userId + ", date="
                + date + ", remarks=" + remarks + ", updateTime=" + updateTime + "]";
    }
